...
export const en: Record<AdminLang, string> = {
    ...
    'orgdetail.link': "Organization's customers link",
    ...
    'commercedetail.pickup': 'Pickup attention',
    'commercedetail.curbside': 'Curbside attention',
    /* commerce edit */
    ...
    'commerceedit.pickup': 'Update service hours pickup',
    'commerceedit.curbside': 'Update service hours curbside',
    'commerceedit.preparation': 'Update preparation time',
    ...
    'createcommerce.pickup': 'Service hours pickup',
    'createcommerce.curbside': 'Service hours curbside',
    'createcommerce.preparation': 'Preparation time',
    ...
    'maintitleedit.image.hint': 'update main title picture',
    'maintitleedit.image.description':
        'Current picture: If you do not select a new main title picture, the current picture will be retained',
    'maintitleedit.image.size': 'file picture size up to 10MB',
    'maintitleedit.image.type': 'file picture type allowed: jpg / png',
    /* create main title */
    ...
    'createmaintitle.image.hint': 'main title picture as jpg/png file',
    'createmaintitle.image.required': 'main title picture is required',
    ...
    'createaddontitle.type.placeholder': 'Choose complement type',
    'createaddontitle.type.hint': 'complement type',
    'createaddontitle.type.required': 'complement type is required',
    'createaddontitle.maxaccusubitem.placeholder': 'Max accumulated sub items',
    'createaddontitle.maxaccusubitem.hint': 'max accumulated sub items',
    'createaddontitle.maxaccusubitem.required': 'max accumulated sub items is required',
    'createaddontitle.maxaccusubitem.min': 'Min value: 2',
    'createaddontitle.maxaccusubitem.max': 'Max value: 10',
    /* product list view */
    ...
    'productdetail.maxaccuitems': 'Max accumulated items',
    ...
    'productdetail.combo': 'Contains combos',
    'productdetail.nocombo': 'Contains no combos',
    ...
    'productedit.price.placeholder': 'Product selling price',
    'productedit.price.hint': 'update product selling price',
    'productedit.price.required': 'product selling price is required',
    ...
    'productedit.maxaccuitems.placeholder': 'Max accumulated items',
    'productedit.maxaccuitems.hint': 'update max accumulated items',
    'productedit.maxaccuitems.required': 'max accumulated items is required',
    ...
    'productedit.addon.required': 'at least an addon collection is required',
    'productedit.combo.title': 'Update combo collection',
    'productedit.combo.placeholder': 'Combo collection',
    'productedit.combo.hint': 'choose combo collection',
    'productedit.combo.required': 'at least a combo collection is required',
    ...
    'createproduct.price.placeholder': 'Product selling price',
    'createproduct.price.hint': 'product selling price',
    'createproduct.price.required': 'product selling price is required',
    ...
    'createproduct.addon.required': 'at least an addon collection is required',
    'createproduct.maxaccuitems.title': 'set max accumulated items?',
    'createproduct.maxaccuitems.placeholder': 'Max accumulated items',
    'createproduct.maxaccuitems.hint': 'set max accumulated items',
    'createproduct.maxaccuitems.required': 'max accumulated items is required',
    'createproduct.maxaccuitems.min': 'min value: 1',
    'createproduct.maxaccuitems.max': 'max value: 10',
    'createproduct.combo.title': 'Mark as combo?',
    'createproduct.combo.placeholder': 'Choose combo collection',
    'createproduct.combo.hint': 'product combo collection',
    'createproduct.combo.required': 'at least a combo collection is required',
